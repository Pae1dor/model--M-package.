...
class PurchaseRequisition(models.Model):
    ...
    def _onchange_project_task(self):
        ...
        if self.project_id:
            ...
            project_key = str(self.project_id.analytic_account_id.id)   # analytic_distribution ใช้ string เป็น key
            for line in self.product_lines:
                line.analytic_distribution = {project_key: 100}  # 100% ให้ project นี้
